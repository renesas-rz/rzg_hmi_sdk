...
=== "RZ/G3E"
    !!! content-wrapper no-indent table-no-sort table-no-hover ""
        ...
        +===============+=======================================================+===============================================+
        | RZ/G3E        | *core-image-weston-smarc-rzg3e.rootfs.wic.gz*         | *image-file_rzg3e_hmi-sdk_v3.4.0.0.zip*       |
        +---------------+-------------------------------------------------------+-----------------------------------------------+
...
=== "RZ/G2L"
    !!! content-wrapper no-indent table-no-sort table-no-hover ""
        ...
        | Target Board  | Image File                                            | Location                                      |
        +===============+=======================================================+===============================================+
        | RZ/G2L        | *core-image-weston-smarc-rzg2l.rootfs.wic.gz*         | *image-file_rzg2l_hmi-sdk_v3.4.1.0.zip*       |
        +---------------+-------------------------------------------------------+-----------------------------------------------+
...
=== "RZ/G2LC"
    !!! content-wrapper no-indent table-no-sort table-no-hover ""
        ...
        | Target Board  | Image File                                            | Location                                      |
        +===============+=======================================================+===============================================+
        | RZ/G2LC       | *core-image-weston-smarc-rzg2lc.rootfs.wic.gz*        | *image-file_rzg2lc_hmi-sdk_v3.4.1.0.zip*      |
        +---------------+-------------------------------------------------------+-----------------------------------------------+
...
6.  Flash the image to the SD card using `bmaptool`.
    ...
    === "RZ/G2L"
        ```bash
        sudo bmaptool copy core-image-weston-smarc-rzg2l.rootfs.wic.gz <device name>
        ```
        {: .dollar }
    
        In this example:
        ```bash
        sudo bmaptool copy core-image-weston-smarc-rzg2l.rootfs.wic.gz /dev/sda
        ```
        {: .dollar }

    === "RZ/G2LC"
        ```bash
        sudo bmaptool copy core-image-weston-smarc-rzg2lc.rootfs.wic.gz <device name>
        ```
        {: .dollar }
    
        In this example:
        ```bash
        sudo bmaptool copy core-image-weston-smarc-rzg2lc.rootfs.wic.gz /dev/sda
        ```
        {: .dollar }

    === "RZ/G2UL"
        ```bash
        sudo bmaptool copy core-image-minimal-smarc-rzg2ul.rootfs.wic.gz <device name>
        ```
        {: .dollar }
