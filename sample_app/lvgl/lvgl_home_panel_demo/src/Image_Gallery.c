...
void create_Image_Gallery(void)
{
    ...
    uint16_t img_ratio = 0;
    static lv_style_t image_btn_style;
    lv_style_init(&image_btn_style);
    lv_style_set_radius(&image_btn_style, 0);

    Image = lv_img_create(Image_Gallery_background);
    lv_obj_set_pos(Image, 564, 344);
    lv_obj_set_size(Image, 959, 539);
    lv_img_set_src(Image, "L:/usr/share/lvgl-home-panel-demo/images/photo_0.jpg");

    after_Image = lv_img_create(Image_Gallery_background);
    lv_obj_set_pos(after_Image, 564, 344);
    lv_obj_set_size(after_Image, 959, 539);

    for (Image_btn_cnt = 0; Image_btn_cnt < 4; Image_btn_cnt++)
    {
        select_Image_btn[Image_btn_cnt] = lv_btn_create(Image_Gallery_background);
        select_Image[Image_btn_cnt] = lv_img_create(select_Image_btn[Image_btn_cnt]);
    ...
    lv_img_set_src(select_Image[0], "L:/usr/share/lvgl-home-panel-demo/images/photo_0.png");
    lv_img_set_src(select_Image[1], "L:/usr/share/lvgl-home-panel-demo/images/photo_1.png");
    lv_img_set_src(select_Image[2], "L:/usr/share/lvgl-home-panel-demo/images/photo_2.png");
    lv_img_set_src(select_Image[3], "L:/usr/share/lvgl-home-panel-demo/images/photo_3.png");
    ...
    for (Image_btn_cnt = 0; Image_btn_cnt < 4; Image_btn_cnt++)
    {
        ...
        lv_img_set_zoom(select_Image[Image_btn_cnt],img_ratio);
        lv_img_set_size_mode(select_Image[Image_btn_cnt], LV_IMG_SIZE_MODE_REAL);
        lv_obj_set_size(select_Image[Image_btn_cnt], LV_SIZE_CONTENT, LV_SIZE_CONTENT);
...
static void animation_event_handler(lv_event_t* e)
{
    ...
    strcpy(select_Image_pass, lv_img_get_src(select_Image));
    ...
    lv_img_set_src(Image, select_Image_pass);
